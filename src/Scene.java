...
public class Scene {
	 ...
	 * 
	 * @param object
	 *            element to start updating from Precondition: -1 <= obj <
	 *            sceneObjects.size()
	 */
...
class Object {
	 ...
	 * 
	 * @param component
	 *            element to start updating from Precondition: -1 <= com <
	 *            sceneObjects.size()
	 */
...
class Component {
	 ...
	 * 
	 * @param sub
	 *            component element to start updating from Precondition: -1 <=
	 *            com < sceneObjects.size()
	 */
